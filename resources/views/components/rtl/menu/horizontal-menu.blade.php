...
/**
*
* Created a new component <x-rtl-menu.horizontal-menu/>.
*
*/
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu {{ Request::is('*/dashboard/*') ? "active" : "" }}">
                        ...
                        <ul class="dropdown-menu submenu dropdown-menu-end  list-unstyled" id="dashboard" data-bs-parent="#accordionExample">
                    ...
                    <li class="menu {{ Request::is('*/app/*') ? "active" : "" }}">
                        ...
                        <ul class="dropdown-menu submenu dropdown-menu-end list-unstyled" id="apps" data-bs-parent="#accordionExample">
                            ...
                            <li class="{{ Request::routeIs('scrumboard') ? 'active' : '' }}">
                                <a href=" /app/scrumboard"> Scrumboard </a>
                            </li>
                            <li class="{{ Request::routeIs('contacts') ? 'active' : '' }}">
                                <a href=" /app/contacts"> Contacts </a>
                            </li>
                            <li class="sub-submenu dropstart {{ Request::is('*/app/invoice/*') ? "active" : "" }}">
                            ...
                            <li class="sub-submenu dropstart {{ Request::is('*/app/ecommerce/*') ? "active" : "" }}">
                                ...
                                <ul class="dropdown-menu list-unstyled sub-submenu" id="ecommerce" data-bs-parent="#apps">
                                    <li class="{{ Request::routeIs('ecommerce-shop') ? 'active' : '' }}">
                                        <a href=" /app/ecommerce/shop"> Shop </a>
                                    </li>
                                    <li class="{{ Request::routeIs('ecommerce-detail') ? 'active' : '' }}">
                                        <a href=" /app/ecommerce/detail"> Product </a>
                                    </li>
                                    <li class="{{ Request::routeIs('ecommerce-list') ? 'active' : '' }}">
                                        <a href=" /app/ecommerce/list"> List </a>
                                    </li>
                                    <li class="{{ Request::routeIs('ecommerce-add') ? 'active' : '' }}">
                                        <a href=" /app/ecommerce/add"> Create </a>
                                    </li>
                                    <li class="{{ Request::routeIs('ecommerce-edit') ? 'active' : '' }}">
                                        <a href=" /app/ecommerce/edit"> Edit </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sub-submenu dropstart {{ Request::is('*/app/blog/*') ? "active" : "" }}">
                    ...
                    <li class="menu {{ Request::is('*/component/*') ? "active" : "" }}">
                        ...
                        <ul class="dropdown-menu submenu dropdown-menu-end list-unstyled" id="components" data-bs-parent="#accordionExample">
                            <li class="{{ Request::routeIs('tabs') ? 'active' : '' }}">
                                <a href=" /component/tabs"> Tabs </a>
                            </li>
                            <li class="{{ Request::routeIs('accordion') ? 'active' : '' }}">
                                <a href=" /component/accordion"> Accordions  </a>
                            </li>
                            <li class="{{ Request::routeIs('modal') ? 'active' : '' }}">
                                <a href=" /component/modal"> Modals </a>
                            </li>
                            <li class="{{ Request::routeIs('cards') ? 'active' : '' }}">
                                <a href=" /component/cards"> Cards </a>
                            </li>
                            <li class="{{ Request::routeIs('bootstrap-carousel') ? 'active' : '' }}">
                                <a href=" /component/bootstrap-carousel">Carousel</a>
                            </li>
                            <li class="{{ Request::routeIs('splide') ? 'active' : '' }}">
                                <a href=" /component/splide">Splide</a>
                            </li>
                            <li class="{{ Request::routeIs('sweetalerts') ? 'active' : '' }}">
                                <a href=" /component/sweetalerts"> Sweet Alerts </a>
                            </li>
                            <li class="{{ Request::routeIs('timeline') ? 'active' : '' }}">
                                <a href=" /component/timeline"> Timeline </a>
                            </li>
                            <li class="{{ Request::routeIs('notification') ? 'active' : '' }}">
                                <a href=" /component/notification"> Notifications </a>
                            </li>
                            <li class="{{ Request::routeIs('media-object') ? 'active' : '' }}">
                                <a href=" /component/media-object"> Media Object </a>
                            </li>
                            ...
                            <li class="{{ Request::routeIs('pricing-table') ? 'active' : '' }}">
                                <a href=" /component/pricing-table"> Pricing Tables </a>
                            </li>
                            <li class="{{ Request::routeIs('lightbox') ? 'active' : '' }}">
                                <a href=" /component/lightbox"> Lightbox </a>
                            </li>
                            <li class="{{ Request::routeIs('drag-drop') ? 'active' : '' }}">
                                <a href=" /component/drag-drop"> Drag and Drop </a>
                            </li>
                            <li class="{{ Request::routeIs('fonticons') ? 'active' : '' }}">
                                <a href=" /component/fonticons"> Font Icons </a>
                            </li>
                            <li class="{{ Request::routeIs('flags') ? 'active' : '' }}">
                                <a href=" /component/flags"> Flag Icons </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu {{ Request::routeIs('table') ? 'active' : '' }} {{ Request::is('*/datatables/*') ? "active" : "" }}">
                        ...
                        <ul class="dropdown-menu submenu dropdown-menu-end list-unstyled" id="tables" data-bs-parent="#accordionExample">

                            <li class="{{ Request::routeIs('table') ? 'active' : '' }}">
                                <a href=" /table"> Tables </a>
                            </li>

                            <li class="sub-submenu dropstart {{ Request::is('*/datatables/*') ? "active" : "" }}">
                                ...
                                <ul class="dropdown-menu list-unstyled sub-submenu" id="datatable" data-bs-parent="#tables">
                                    ...
                                    <li class="{{ Request::routeIs('striped-table') ? 'active' : '' }}">
                                        <a href=" /datatables/striped-table"> Striped </a>
                                    </li>
                                    <li class="{{ Request::routeIs('custom') ? 'active' : '' }}">
                                        <a href=" /datatables/custom"> Custom </a>
                                    </li>
                                    <li class="{{ Request::routeIs('miscellaneous') ? 'active' : '' }}">
                                        <a href=" /datatables/miscellaneous"> Miscellaneous </a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <li class="menu {{ Request::is('*/page/*') ? "active" : "" }} {{ Request::is('*/user/*') ? "active" : "" }}">
                        ...
                        <ul class="dropdown-menu submenu dropdown-menu-end list-unstyled" id="pages" data-bs-parent="#accordionExample">
                            <li class="{{ Request::routeIs('knowledge-base') ? 'active' : '' }}">
                                <a href=" /page/knowledge-base"> Knowledge Base </a>
                            </li>
                            <li class="{{ Request::routeIs('faq') ? 'active' : '' }}">
                                <a href=" /page/faq"> FAQ </a>
                            </li>
                            <li class="{{ Request::routeIs('contact-us') ? 'active' : '' }}">
                                <a href=" /page/contact-us"> Contact Form </a>
                            </li>
                            <li class="{{ Request::routeIs('profile') ? 'active' : '' }}">
                                <a href=" /user/profile"> Users </a>
                            </li>
                            ...
                            <li>
                                <a href=" /page/maintenance"> Maintanence </a>
                            </li>
                            <li class="sub-submenu dropstart">
                                ...
                                <ul class="dropdown-menu list-unstyled sub-submenu" id="login" data-bs-parent="#pages">
                                    <li>
                                        <a href=" /authentication/boxed/signin"> Boxed </a>
                                    </li>
                                    <li>
                                        <a href=" /authentication/cover/signin"> Cover </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sub-submenu dropstart">
                                ...
                                <ul class="dropdown-menu list-unstyled sub-submenu" id="signup" data-bs-parent="#pages">
                                    <li>
                                        <a href=" /authentication/boxed/signup"> Boxed </a>
                                    </li>
                                    <li>
                                        <a href=" /authentication/cover/signup"> Cover </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sub-submenu dropstart">
                                ...
                                <ul class="dropdown-menu list-unstyled sub-submenu" id="unlock" data-bs-parent="#pages">
                                    <li>
                                        <a href=" /authentication/boxed/lockscreen"> Boxed </a>
                                    </li>
                                    <li>
                                        <a href=" /authentication/cover/lockscreen"> Cover </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sub-submenu dropstart">
                                ...
                                <ul class="dropdown-menu list-unstyled sub-submenu" id="reset" data-bs-parent="#pages">
                                    <li>
                                        <a href=" /authentication/boxed/password-reset"> Boxed </a>
                                    </li>
                                    <li>
                                        <a href=" /authentication/cover/password-reset"> Cover </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sub-submenu dropstart">
                                ...
                                <ul class="dropdown-menu list-unstyled sub-submenu" id="twoStep" data-bs-parent="#pages">
                                    <li>
                                        <a href=" /authentication/boxed/2-step-verification"> Boxed </a>
                                    </li>
                                    <li>
                                        <a href=" /authentication/cover/2-step-verification"> Cover </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li class="menu {{ Request::routeIs('maps') ? 'active' : '' }} {{ Request::routeIs('charts') ? 'active' : '' }} {{ Request::routeIs('widgets') ? 'active' : '' }} {{ Request::is('*/layout/*') ? "active" : "" }}">
                        ...
                        <ul class="dropdown-menu submenu dropdown-menu-end list-unstyled" id="more" data-bs-parent="#accordionExample">
                            ...
                            <li class="sub-submenu dropstart {{ Request::is('*/layout/*') ? "active" : "" }}">
                                ...
                                <ul class="dropdown-menu list-unstyled sub-submenu" id="layouts" data-bs-parent="#more">
                                    <li class="{{ Request::routeIs('blank') ? 'active' : '' }}">
                                        <a href=" /layout/blank"> Blank Page </a>
                                    </li>
                                    <li class="{{ Request::routeIs('empty') ? 'active' : '' }}">
                                        <a href=" /layout/empty"> Empty Page </a>
                                    </li>
                                    <li class="{{ Request::routeIs('fullWidth') ? 'active' : '' }}">
                                        <a href=" /layout/full-width"> Full Width </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
