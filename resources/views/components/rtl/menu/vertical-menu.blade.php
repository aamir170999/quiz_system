            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu {{ Request::routeIs('mailbox') ? 'active' : '' }}">
                        <a href=" /app/mailbox" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::routeIs('todolist') ? 'active' : '' }}">
                        <a href=" /app/todo-list" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::routeIs('notes') ? 'active' : '' }}">
                        <a href=" /app/notes" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::routeIs('scrumboard') ? 'active' : '' }}">
                        <a href=" /app/scrumboard" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::routeIs('maps') ? 'active' : '' }}">
                        <a href=" /maps" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::routeIs('charts') ? 'active' : '' }}">
                        <a href=" /charts" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::routeIs('widgets') ? 'active' : '' }}">
                        <a href=" /widgets" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::is('*/layout/*') ? "active" : "" }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ Request::is('*/layout/*') ? "show" : "" }}" id="layouts" data-bs-parent="#accordionExample">
                            ...
                            <li class="{{ Request::routeIs('collapsibleMenu') ? 'active' : '' }}">
                                <a href=" /layout/collapsible-menu"> Collapsed Menu </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu {{ Request::routeIs('table') ? 'active' : '' }}">
                        <a href=" /table" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="authentication" data-bs-parent="#accordionExample">
                            <li>
                                <a href=" /authentication/boxed/signin"> Sign In </a>
                            </li>
                            <li>
                                <a href=" /authentication/boxed/signup"> Sign Up </a>
                            </li>
                            <li>
                                <a href=" /authentication/boxed/lockscreen"> Unlock </a>
                            </li>
                            <li>
                                <a href=" /authentication/boxed/password-reset"> Reset </a>
                            </li>
                            <li>
                                <a href=" /authentication/boxed/2-step-verification"> 2 Step </a>
                            </li>
                            <li>
                                <a href=" /authentication/cover/signin"> Sign In Cover </a>
                            </li>
                            <li>
                                <a href=" /authentication/cover/signup"> Sign Up Cover </a>
                            </li>
                            <li>
                                <a href=" /authentication/cover/lockscreen"> Unlock Cover </a>
                            </li>
                            <li>
                                <a href=" /authentication/cover/password-reset"> Reset Cover </a>
                            </li>
                            <li>
                                <a href=" /authentication/cover/2-step-verification"> 2 Step Cover </a>
                            </li>
                        </ul>
                    </li>
