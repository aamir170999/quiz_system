var App = (function () {
    ...
    var toggleFunction = {
        sidebar: function ($recentSubmenu) {
            var sidebarCollapseEle =
                document.querySelectorAll(".sidebarCollapse");
                ...
                el.addEventListener("click", function (sidebar) {
                    ...
                    if ($recentSubmenu === true) {
                        if (
                            ...
                            if (
                                Dom.class.mainContainer.classList.contains(
                                    "sidebar-closed"
                                )
                            ) {
                                if (
                            ...
                            if (
                                ...
                                if (e === "mouseenter") {
                                    ...
                                    getMenuList.forEach((element) => {
                                        ...
                                        if (submenuShowEle) {
                                            submenuShowEle.classList.remove(
                                                "show"
                                            );
                                        }

                                        var submenuExpandedToggleEle =
                                            element.querySelector(
        ...
        search: function () {
            if (Dom.class.search) {
                ...
                Dom.class.searchOverlay.addEventListener(
                    "click",
                    function (event) {
    ...
    var inBuiltfunctionality = {
        preventScrollBody: function () {
            ...
            nonScrollableElement.forEach((preventScroll) => {
                ...
                preventScroll.addEventListener(
                    "DOMMouseScroll",
                    preventScrolling
                );
            });
